...
buildrpm() {
  ...
  rpm -qa
  yum -y install wget ant java-1.6.0-openjdk java-1.6.0-openjdk-devel java-1.6.0-openjdk-headless
  ...
  cp ${directory}/apache-tomcat-initscript ${directory}/rpmbuild/SOURCES/
